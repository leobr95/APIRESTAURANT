...
namespace WebAPI.Controllers
{
    ...
    [ApiController]
    public class FacturaCompletasController : ControllerBase
    {
        private readonly FacturaContext _context;

        public FacturaCompletasController(FacturaContext context)
        {
            _context = context;
        }
        //read
        [HttpGet]
        public async Task<ActionResult<IEnumerable<FacturaCompleta>>> GetFacturaItems()
        {

            return await _context.FacturaCompleta.FromSqlRaw("exec dbo.Consulta_Facturas").ToListAsync();
        }
